...
const NewRelicSnippet = () => {
    ...
    return <Head>
    <script type = "text/javascript" dangerouslySetInnerHTML={{ __html: newRelicSource}}  />
    </Head>
};
...
NREUM.loader_config = {
    ...
    trustKey: "2951339",
    agentID: "826431565",
    licenseKey: "NRJS-0caab25f62834c62732",
    applicationID: "826431565"
};
NREUM.info = {
    beacon: "bam.nr-data.net",
    errorBeacon: "bam.nr-data.net",
